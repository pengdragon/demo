<template>
  <div class="container-wrapper">
      ...
      <el-col class="form-content">
        <el-form :model="formData" inline size="medium" class="formFlexBox" :label-width="'90px'">
          <el-form-item class="dateGroup">
            <el-form-item label="出货时间：" class="formItem">
              <el-date-picker
    ...
    <el-dialog title="出库明细" :visible.sync="showOrderDetail" class="choose">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.$axios.post('/api/purchase/order/listStockoutDetails', data)
        .then((response) => {
          if (response.data) {
