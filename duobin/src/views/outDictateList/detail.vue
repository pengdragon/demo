<template>
  <div class="view-main">
    <layout :order="formData"
            :showStatus="true" @submitHandle='submitHandle' @uploadConfim='handleChange' :editStatus='false'
            :fileListProp="formData.file">
          ...
          <el-col class="form-wrapper">
            ...
            <el-form :label-width="'100px'"
              ...
              <el-form-item label="内部订单号：" class="formItem">
                <el-input v-model="formData.customOrder" readonly
                          class="inputBox"
                          placeholder="">
                </el-input>
              </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="供应商：">
                  <el-select v-model="formData.supplier" filterable placeholder="请选择" style="width: 100%">
                    <el-option
                      v-for="sup in supplier" disabled
                      :key="sup.name"
                      :label="sup.name"
                      :value="sup.name">
                    </el-option>
              ...
              <el-form-item label="币别：" class="formItem" style="width: 150px;display: inline-block">
                <el-select v-model="formData.currency" placeholder="请选择" class="inputBox" style="width: 150px;">
                  <el-option
                    v-for="(item,i) in currencyOptions" disabled
                    :key="i"
...
<script>
  ...
  import layout from '../newOutDictate/layout'
