          ...
          <el-col class="sendGoods form-wrapper">
            ...
            <el-form :label-width="'110px'"
              ...
              <el-form-item label="出货方式：" class="formItem Shipments">
                <el-radio v-model="formData.shipmentType" disabled label="自提" @change="selfLifting(formData.shipmentType)">自提
                </el-radio>
                <el-radio v-model="formData.shipmentType" disabled label="送货" @change="selfLifting(formData.shipmentType)">送货
                </el-radio>
                <el-radio v-model="formData.shipmentType" disabled label="快递" @change="selfLifting(formData.shipmentType)">快递
                </el-radio>
              </el-form-item>
              <div class="self form-content" v-if="formData.shipmentType=='自提'">
                <el-form-item label="自提公司：" class="formItem">
                  <el-input v-model="formData.sendCompany" readonly
                            class="inputBox"
...
<!--            <el-button type="primary" size="small">选择库存</el-button>-->
