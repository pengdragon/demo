<template>
  ...
  <div class="view-main">
    <layout :order="formData"
            ...
            :fileListProp="formData.fileList" :editStatus="false">
            ...
            <el-form :label-width="'110px'"
              ...
              <div class="logistics form-content" v-if="logistics">
                <el-form-item label="提货公司：" class="formItem">
                  <el-input v-model="formData.pickGoodsCompany" readonly
                            class="inputBox"
                ...
                <el-form-item label="联系人：" class="formItem">
                  <div style="width: 360px;">
                    <el-input v-model="formData.contactsName" readonly
                              class="inputName"
                              placeholder="姓名"></el-input>
                    <el-input v-model="formData.contactsPhone" readonly
                              class="inputTel"
                ...
                <el-form-item label="提货地址：" class="formItem Shipments">
                  ...
                  <el-input v-model="formData.pickGoodsAddress" readonly
                            class="inputBox"
                ...
                <el-form-item label="可提货时间：" class="formItem">
                  <div style="width: 360px;">
                    <el-date-picker
                      v-model="formData.predictPickGoodsTime" readonly
                      type="date"
                      class="inputTel"
                      placeholder="选择日期">
                    </el-date-picker>
                ...
                <el-form-item label="数量：" class="formItem">
                  <div style="width: 360px;">
                    <el-input v-model="formData.sumBoard" readonly
                              class="inputName2"
                              placeholder=""></el-input>
                    板
                    <el-input v-model="formData.sumCartons" readonly
                              class="inputTel2"
                              placeholder=""></el-input>
                    箱
                  </div>
    ...
    methods: {
      ...
      submitHandle(v) {
        ...
        if (v === '保存') {
          ...
          // this.$axios.post('/api/purchase/order/addPickApply',this.order)
          // .then((response) => {
