    ...
    <div class="container-wrapper">
      <b2bSearch @searchEvent="searchEvent">
        <div slot="button" style="margin-bottom: 22px">
          <el-button size="small" type="primary" @click="$router.push('/export/newEntrustPay')">付款委托申请</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      deleteItem() {
        ...
        this.$axios.post('api/export/finance/paymentobject/delete', { id }).then((res) => {
          // 提示
          this.$notify({
            type: 'success',
            title: '成功',
